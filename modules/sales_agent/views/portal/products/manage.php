        ...
        <div class="col-md-3">
          ...
          <select name="product_group" id="group_item" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('all'); ?>" >
            <option value=""></option>
              ...
              <option value="<?php echo sa_html_entity_decode($s['id']); ?>" ><?php echo sa_html_entity_decode($s['name']); ?></option>
                <?php } ?>
          </select>  
        </div>
         ...
         <div class="col-md-3">
          <label for="group_item"><?php echo _l('sa_programs'); ?></label>
            ...
            <option value=""></option>
              ...
              <option value="<?php echo sa_html_entity_decode($program['id']); ?>" ><?php echo sa_html_entity_decode($program['name']); ?></option>
                <?php } ?>
          </select>  
         </div>
      </div>
