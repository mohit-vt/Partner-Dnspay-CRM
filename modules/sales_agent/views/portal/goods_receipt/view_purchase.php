            ...
            <table class="table border table-striped table-margintop" >
              <tbody>
                  ...
                  <tr class="project-overview">
                    ...
                    <td><?php echo sa_html_entity_decode($goods_receipt->deliver_name) ; ?></td>
                 </tr>
        
                <tr class="project-overview">
                    <td class="bold"><?php echo _l('stock_received_docket_code'); ?></td>
                    <td><?php echo sa_html_entity_decode($goods_receipt->goods_receipt_code) ; ?></td>
                 </tr>
                <tr class="project-overview">
                    <td class="bold"><?php echo _l('note_'); ?></td>
                    <td><?php echo sa_html_entity_decode($goods_receipt->description) ; ?></td>
                 </tr>
                        ...
                        <div class="table-responsive">
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                            ...
                            ?>
                              ...
                              <tr data-toggle="tooltip" data-original-title="<?php echo sa_html_entity_decode($name_serial_number_tooltip); ?>">
                              <td ><?php echo sa_html_entity_decode($receipt_key) ?></td>
                                  <td ><?php echo sa_html_entity_decode($commodity_name) ?></td>
                                  <td ><?php echo sa_html_entity_decode($warehouse_code) ?></td>
                                  <td ><?php echo sa_html_entity_decode($unit_name) ?></td>
                                  <td ></td>
                                  <td class="text-right" ><?php echo sa_html_entity_decode($quantities) ?></td>
                                  ...
                                  <td class="text-right"><?php echo sa_html_entity_decode($lot_number) ?></td>
                      ...
                      <table class="table text-right table-margintop">
                        <tbody>
                          ...
                          <?php if(isset($goods_receipt) && $tax_data['html_currency'] != ''){
                            echo sa_html_entity_decode($tax_data['html_currency']);
                          } ?>
        ...
        <div class="modal-body">
         <p class="bold" id="signatureLabel"><?php echo _l('signature'); ?></p>
          ...
          <div class="modal-footer">
           ...
           <button onclick="sign_request(<?php echo sa_html_entity_decode($goods_receipt->id); ?>);"  autocomplete="off" class="btn btn-success sign_request_class"><?php echo _l('e_signature_sign'); ?></button>
          </div>
