<div class="col-md-12 mtop15">
   <div class="panel_s">
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <h4><?php echo sa_html_entity_decode($goods_delivery->goods_delivery_code) ?></h4>
          </div>
        </div>
                ...
                if($goods_delivery){
                 ...
                 ?>
                  ...
                  <tr class="project-overview">
                    ...
                    <td><?php echo sa_html_entity_decode($customer_name) ; ?></td>
                 </tr>
                 <tr class="project-overview">
                    <td class="bold"><?php echo _l('to'); ?></td>
                    <td><?php echo sa_html_entity_decode($goods_delivery->to_) ; ?></td>
                 </tr>
                <tr class="project-overview">
                    <td class="bold"><?php echo _l('address'); ?></td>
                    <td><?php echo sa_html_entity_decode($goods_delivery->address) ; ?></td>
                 </tr>
                 <tr class="project-overview">
                    <td class="bold"><?php echo _l('note_'); ?></td>
                    <td><?php echo sa_html_entity_decode($goods_delivery->description) ; ?></td>
                 </tr>
                        ...
                        <div class="table-responsive">
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                            ...
                            ?>
                              ...
                              <tr>
                              <td ><?php echo sa_html_entity_decode($delivery) ?></td>
                                  <td ><?php echo sa_html_entity_decode($commodity_name) ?></td>
                                  <td ><?php echo sa_html_entity_decode($warehouse_name) ?></td>
                                  <td ><?php echo sa_html_entity_decode($available_quantity) ?></td>
                                  ...
                                  <td class="text-right"><?php echo sa_html_entity_decode($guarantee_period) ?></td>
                                </tr>
                             <?php  } ?>
                              </tbody>
                           </table>
