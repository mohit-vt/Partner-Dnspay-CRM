...
<?php hooks()->do_action('sa_contract_head_element'); ?>
<div class="mtop15 preview-top-wrapper">
   ...
   <div class="top" data-sticky data-sticky-class="preview-sticky-header">
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               <h4 class="pull-left no-mtop contract-html-subject"><?php echo sa_html_entity_decode($contract->subject); ?><br />
                  <small><?php echo sa_html_entity_decode($contract->type_name); ?></small>
               </h4>
               ...
               <a href="<?php echo site_url('sales_agent/portal/purchase_contracts'); ?>" class="btn btn-default mright5 pull-right action-button go-to-portal">
   ...
   <div class="col-md-8 contract-left">
      <div class="panel_s mtop20">
         <div class="panel-body tc-content padding-30 contract-html-content">
            <?php echo sa_html_entity_decode($contract->content); ?>
         </div>
      </div>
   </div>
            ...
            <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-number">
                     <?php echo sa_html_entity_decode($contract->id); ?>
                  </div>
                  ...
                  <div class="col-md-7 contract-type">
                     <?php echo sa_html_entity_decode($contract->type_name); ?>
                  </div>
                  <?php } ?>
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-contract-signed-by">
                     <?php echo sa_html_entity_decode($contract->acceptance_ip); ?>
                  </div>
               </div>
               <?php } ?>
            </div>
            <div role="tabpanel" class="tab-pane<?php if($this->input->get('tab') === 'discussion'){echo ' active';} ?>" id="discussion">
               ...
               <?php
                  ...
                  if($comment['staffid'] != 0){
                    ...
                    $comment_html .= _l('is_agent_indicator');
                  }
                  $comment_html .= '</b>';
                  ...
                  echo sa_html_entity_decode($comment_html); ?>
            </div>
         </div>
      </div>
   </div>
...
<?php
   get_sale_agent_template_part('identity_confirmation_form', array('formData' => form_hidden('action', 'sign_contract')));
   ?>
<script>
   $(function(){
