...
<?php $CI = &get_instance();
    ...
    add_bootstrap_select_js_assets('customers-area-default'); ?>
...
<div class="col-md-10 col-md-offset-1">
    <?php echo form_open('sales_agent/authentication_sales_agent/register', ['id'=>'register-form']); ?>
    <div class="panel_s">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group register-country-group">
                        ...
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="country" class="form-control selectpicker" id="country">
                            ...
                            <option value="<?php echo sa_html_entity_decode($country['country_id']); ?>"<?php if(get_option('customer_default_country') == $country['country_id']){echo ' selected';} ?> <?php echo set_select('country', $country['country_id']); ?>><?php echo sa_html_entity_decode($country['short_name']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
