	...
	<div class="panel_s">
          ...
          <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
             <div class="top_stats_wrapper minheight85">
                 ...
                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm fa-brands fa-product-hunt"></i> <?php echo _l('sa_program_participated'); ?>
                 </p>
                    <span class="pull-right bold no-mtop fontsize24"><?php echo sa_html_entity_decode($program_participated); ?></span>
                 </a>
                 ...
                 <div class="progress no-margin progress-bar-mini">
                  <?php 
                    ...
                    <div class="progress-bar progress-bar-info no-percent-text not-dynamic width-100" role="progressbar" aria-valuenow="<?php echo sa_html_entity_decode($program_participated); ?>" aria-valuemin="0" aria-valuemax="<?php echo sa_html_entity_decode($program_participated); ?>" style="width: <?php echo sa_html_entity_decode($percentage); ?>%" data-percent="100%">
                    </div>
                 </div>
              </div>
          </div>
          ...
          <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
             <div class="top_stats_wrapper minheight85">
                 ...
                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm fa fa-cubes"></i> <?php echo _l('total_items'); ?>
                    ...
                    <span class="pull-right bold no-mtop fontsize24"><?php echo sa_html_entity_decode($total_items); ?></span>
                 </a>
                 <div class="clearfix"></div>
                 <div class="progress no-margin progress-bar-mini">
                  <?php 
                    ...
                    <div class="progress-bar progress-bar-warning no-percent-text not-dynamic width-100" role="progressbar" aria-valuenow="<?php echo sa_html_entity_decode($total_items); ?>" aria-valuemin="0" aria-valuemax="<?php echo sa_html_entity_decode($total_items); ?>" style="width: <?php echo sa_html_entity_decode($percentage); ?>%" data-percent="100%">
                    </div>
                 </div>
              </div>
          </div>
          ...
          <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
             <div class="top_stats_wrapper minheight85">
                 ...
                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm fa fa-cart-plus"></i> <?php echo _l('total_purchase_orders'); ?>
                    ...
                    <span class="pull-right bold no-mtop fontsize24"><?php echo sa_html_entity_decode($total_purchase_orders); ?></span>
                 </a>
                 <div class="clearfix"></div>
                 <div class="progress no-margin progress-bar-mini">
                  <?php 
                    ...
                    <div class="progress-bar progress-bar-danger no-percent-text not-dynamic width-100" role="progressbar" aria-valuenow="<?php echo sa_html_entity_decode($total_purchase_orders); ?>" aria-valuemin="0" aria-valuemax="<?php echo sa_html_entity_decode($total_purchase_orders); ?>" style="width: <?php echo sa_html_entity_decode($percentage); ?>%" data-percent="100%">
                    </div>
                 </div>
              </div>
          </div>
          ...
          <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
             <div class="top_stats_wrapper minheight85">
                 ...
                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm fa fa-clipboard"></i> <?php echo _l('total_sale_invoices'); ?>
                    ...
                    <span class="pull-right bold no-mtop fontsize24"><?php echo sa_html_entity_decode($total_sale_invoices); ?></span>
                 </a>
                 <div class="clearfix"></div>
                 <div class="progress no-margin progress-bar-mini">
                  <?php 
                    ...
                    <div class="progress-bar progress-bar-success no-percent-text not-dynamic width-100" role="progressbar" aria-valuenow="<?php echo sa_html_entity_decode($total_sale_invoices); ?>" aria-valuemin="0" aria-valuemax="<?php echo sa_html_entity_decode($total_sale_invoices); ?>" style="width: <?php echo sa_html_entity_decode($percentage); ?>%" data-percent="100%">
                    </div>
                 </div>
              </div>
          </div>
