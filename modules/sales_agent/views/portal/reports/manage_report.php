	                  ...
	                  <div id="currency" class="form-group hide">
	                     ...
	                     <select class="selectpicker" name="currency" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
	                        <?php foreach($currencies as $currency){
	                           ...
	                           ?>
	                           <option value="<?php echo sa_html_entity_decode($currency['id']); ?>" <?php echo sa_html_entity_decode($selected); ?>><?php echo sa_html_entity_decode($currency['name']); ?></option>
	                           <?php } ?>
	                        </select>
	                     </div>
	                <?php } ?>
                     ...
                     <div class="form-group hide" id="year_requisition">
                        ...
                        <select  name="year_requisition" id="year_requisition"  class="selectpicker"  data-width="100%" data-none-selected-text="<?php echo _l('filter_by').' '._l('year'); ?>">
                              <option value="<?php echo sa_html_entity_decode($y0); ?>" <?php echo 'selected' ?>><?php echo _l('year').' '. sa_html_entity_decode($y0) ; ?></option>
                              <option value="<?php echo sa_html_entity_decode($y1); ?>"><?php echo _l('year').' '. sa_html_entity_decode($y1) ; ?></option>
                              <option value="<?php echo sa_html_entity_decode($y2); ?>"><?php echo _l('year').' '. sa_html_entity_decode($y2) ; ?></option>
                              <option value="<?php echo sa_html_entity_decode($y3); ?>"><?php echo _l('year').' '. sa_html_entity_decode($y3) ; ?></option>
