	...
	<div class="panel_s">
	 	<div class="panel-body">
	 		<div class="clearfix"></div>
                           <h4>
                              <?php echo sa_html_entity_decode($warehouse_item->warehouse_name); ?>
                           </h4>
                              ...
                              <table class="table border table-striped table-margintop">
                                  <tbody>
                                      ...
                                      <tr class="project-overview">
                                        ...
                                        <td><?php echo sa_html_entity_decode($warehouse_item->warehouse_code) ; ?></td>
                                     </tr>
                                     <tr class="project-overview">
                                        <td class="bold"><?php echo _l('warehouse_name'); ?></td>
                                        <td><?php echo sa_html_entity_decode($warehouse_item->warehouse_name) ; ?></td>
                                     </tr>
                                     <?php 
                                     $address='';
                                ...
                                # code...
                                    ...
                                    ?>
                                     <tr class="project-overview">
                                        ...
                                        <td><?php echo sa_html_entity_decode($address) ; ?></td>
                                     </tr>
                                    ...
                                    <tr class="project-overview">
                                        ...
                                        <td><?php echo sa_html_entity_decode($warehouse_item->order) ; ?></td>
                                     </tr>
                                     <tr class="project-overview">
                                        <td class="bold"><?php echo _l('note'); ?></td>
                                        <td><?php echo sa_html_entity_decode($warehouse_item->note) ; ?></td>
                                     </tr>
                                          ...
                                          <table class="table dt-table border table-striped">
                                             ...
                                             <thead>
                                              ...
                                              <tbody>
                                                <?php foreach($warehouse_inventory as $wh_inventory){ ?>
                                                  ...
                                                  <?php 
                                                      ...
                                                      $item =  sa_get_commodity_name($wh_inventory['commodity_id']);
                                                      if(!is_array($item) && isset($item)){
                                                        ...
                                                        if($item->unit_id != 0 && $item->unit_id != ''){
                                                            $unit_value = sa_get_unit_type($item->unit_id );
                                                            if($unit_value){
                                                        ...
                                                        if($item->tax != 0 && $item->tax != ''){
                                                            $tax_value = sa_get_tax_rate($item->tax);
                                                            if($tax_value){
                                              ...
                                              <?php if(!is_array($item) && isset($item)){ ?> 
                                                <tr>
                                                    <td><?php echo sa_html_entity_decode(sa_get_item_variatiom($wh_inventory['commodity_id'])); ?></td>
                                                    <td><?php echo sa_html_entity_decode($item_sku_code); ?></td>
                                                    <td><?php echo sa_html_entity_decode($wh_inventory['inventory_number']); ?></td>
                                                    <td><?php echo sa_html_entity_decode($item_unit); ?></td>
                                                    <td><?php echo sa_html_entity_decode( app_format_money((float)$rate,'')); ?></td>
                                                  
                                                    <td><?php echo sa_html_entity_decode($item_tax); ?></td>
                                                    <td><?php echo sa_html_entity_decode($status); ?></td>
