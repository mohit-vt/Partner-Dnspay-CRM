         ...
         <div class="col-md-12">
            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php if(has_permission('sa_management', '', 'create') || has_permission('customers', '', 'create')){ ?>
                     <a href="<?php echo admin_url('sales_agent/sale_agent'); ?>" class="btn btn-info mright5 test pull-left display-block">
                     <?php echo _l('new_agent'); ?></a>
	               <?php } ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-left width300" >
                           ...
                           <li class="dropdown-submenu pull-left groups">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="customer_group_<?php echo sa_html_entity_decode($group['id']); ?>" onclick="dt_custom_view('customer_group_<?php echo sa_html_entity_decode($group['id']); ?>','.table-clients','customer_group_<?php echo sa_html_entity_decode($group['id']); ?>'); return false;"><?php echo sa_html_entity_decode($group['name']); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                           ...
                           <li class="dropdown-submenu pull-left countries">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="country_<?php echo sa_html_entity_decode($country['country_id']); ?>" onclick="dt_custom_view('country_<?php echo sa_html_entity_decode($country['country_id']); ?>','.table-clients','country_<?php echo sa_html_entity_decode($country['country_id']); ?>'); return false;"><?php echo sa_html_entity_decode($country['short_name']); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                           ...
                           <li class="dropdown-submenu pull-left invoice">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="invoices_<?php echo sa_html_entity_decode($status); ?>" onclick="dt_custom_view('invoices_<?php echo sa_html_entity_decode($status); ?>','.table-clients','invoices_<?php echo sa_html_entity_decode($status); ?>'); return false;"><?php echo _l('customer_have_invoices_by',format_invoice_status($status,'',false)); ?></a>
                                 </li>
                                 <?php } ?>
                              </ul>
                           </li>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="estimates_<?php echo sa_html_entity_decode($status); ?>" onclick="dt_custom_view('estimates_<?php echo sa_html_entity_decode($status); ?>','.table-clients','estimates_<?php echo sa_html_entity_decode($status); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left project">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="projects_<?php echo sa_html_entity_decode($status['id']); ?>" onclick="dt_custom_view('projects_<?php echo sa_html_entity_decode($status['id']); ?>','.table-clients','projects_<?php echo sa_html_entity_decode($status['id']); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left proposal">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="proposals_<?php echo sa_html_entity_decode($status); ?>" onclick="dt_custom_view('proposals_<?php echo sa_html_entity_decode($status); ?>','.table-clients','proposals_<?php echo sa_html_entity_decode($status); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left contract_types">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="contract_type_<?php echo sa_html_entity_decode($type['id']); ?>" onclick="dt_custom_view('contract_type_<?php echo sa_html_entity_decode($type['id']); ?>','.table-clients','contract_type_<?php echo sa_html_entity_decode($type['id']); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left responsible_admin">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="responsible_admin_<?php echo sa_html_entity_decode($cadmin['staff_id']); ?>" onclick="dt_custom_view('responsible_admin_<?php echo sa_html_entity_decode($cadmin['staff_id']); ?>','.table-clients','responsible_admin_<?php echo sa_html_entity_decode($cadmin['staff_id']); ?>'); return false;">
                  ...
                  <div class="row mbot15">
                     <div class="col-md-12">
                        <h4 class="no-margin"><?php echo _l('agent_summary'); ?></h4>
                     </div>
                     <div class="col-md-2 col-xs-6 border-right">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary . $where_agent,5) : substr($where_agent,5) )); ?></h3>
                        <span class="text-dark"><?php echo _l('agent_summary_total'); ?></span>
                     </div>
                     <div class="col-md-2 col-xs-6 border-right">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'clients','active=1'.$where_summary. $where_agent); ?></h3>
                        <span class="text-success"><?php echo _l('active_agent'); ?></span>
                     </div>
                     <div class="col-md-2 col-xs-6 border-right">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'clients','active=0'.$where_summary. $where_agent); ?></h3>
                        <span class="text-danger"><?php echo _l('inactive_active_agent'); ?></span>
                     </div>
                     <div class="col-md-2 col-xs-6 border-right">
                     	<?php $where_contact = ' AND userid IN (SELECT userid FROM '.db_prefix().'clients WHERE client_type = "agent")'; ?>
                        <h3 class="bold"><?php echo total_rows(db_prefix().'contacts','active=1'.$where_summary. $where_contact); ?></h3>
                        <span class="text-info"><?php echo _l('agent_summary_active'); ?></span>
                     </div>
                     <div class="col-md-2  col-xs-6 border-right">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'contacts','active=0'.$where_summary. $where_contact); ?></h3>
                        <span class="text-danger"><?php echo _l('agent_summary_inactive'); ?></span>
                     </div>
                  ...
                  <div class="checkbox">
                     ...
                     <label for="exclude_inactive"><?php echo _l('sa_exclude_inactive'); ?> <?php echo _l('agents'); ?></label>
                  </div>
...
<script>
   $(function(){
       ...
       var tAPI = initDataTable('.table-clients', admin_url+'sales_agent/table', [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(2,'asc'))); ?>);
