         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php } ?>
                  <?php
                     $path = SALES_AGENT_MODULE_UPLOAD_FOLDER.'/pur_order/'.$file->rel_id.'/'.$file->file_name;
                     if(is_image($path)){ ?>
                  <img src="<?php echo base_url(SA_PATH.'pur_order/'.$file->rel_id.'/'.$file->file_name); ?>" class="img img-responsive ">
                  ...
                  <iframe src="<?php echo base_url(SA_PATH.'pur_order/'.$file->rel_id.'/'.$file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
                  <?php } else if(strpos($file->file_name,'.xls') !== false && empty($file->external)){ ?>
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo base_url(SA_PATH.'pur_order/'.$file->rel_id.'/'.$file->file_name); ?>' width='100%' height='100%' frameborder='0'>
                  </iframe>
