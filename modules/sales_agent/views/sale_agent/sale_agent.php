   ...
   <div class="content">
      <div class="row">
         <div class="col-md-12">
            ...
            <?php } ?>
            <?php if(isset($client) && (!has_permission('sa_management','','view') && is_customer_admin($client->userid))){?>
         ...
         <div class="col-md-3">
            <div class="panel_s mbot5">
               <div class="panel-body padding-10">
                  <h4 class="bold">
                     #<?php echo sa_html_entity_decode($client->userid . ' ' . $title); ?>
                     <?php if(has_permission('sa_management','','delete') || is_admin()){ ?>
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           ...
                           <?php } ?>
                           <?php if(has_permission('sa_management','','delete')){ ?>
                           <li>
                     ...
                     <?php if(isset($client) && $client->leadid != NULL){ ?>
                        ...
                        <small>
                           ...
                           <a href="<?php echo admin_url('leads/index/'.$client->leadid); ?>" onclick="init_lead(<?php echo sa_html_entity_decode($client->leadid); ?>); return false;">
                             - <?php echo _l('view'); ?>
                          </a>
                       </small>
                    <?php } ?>
            ...
            <?php $this->load->view('sale_agent/tabs'); ?>
         </div>
         <?php } ?>
...
<script>
   $(function(){
      init_rel_tasks_table(<?php echo sa_html_entity_decode($client->userid); ?>,'customer');
   });
</script>
<?php } ?>
