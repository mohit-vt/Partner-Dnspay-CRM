...
(function($) {
    "use strict";
    rec_chart_by_status('po_by_delivery_status',<?php echo sa_html_entity_decode($po_by_delivery_status); ?>, <?php echo json_encode(_l('po_by_delivery_status')); ?>);
    rec_chart_by_status('invoice_by_status',<?php echo sa_html_entity_decode($invoice_by_status); ?>, <?php echo json_encode(_l('invoice_by_status')); ?>);
