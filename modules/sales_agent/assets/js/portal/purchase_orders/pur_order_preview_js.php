<script>
var pur_order_id = '<?php echo sa_html_entity_decode($estimate->id); ?>';
(function($) {
  "use strict"; 
   var data_send_mail = {};
  <?php if(isset($send_mail_approve)){ 
    ...
    data_send_mail.rel_id = <?php echo sa_html_entity_decode($estimate->id); ?>;
    data_send_mail.rel_type = 'pur_order';
    data_send_mail.addedfrom = <?php echo sa_html_entity_decode($estimate->addedfrom); ?>;
...
function send_request_approve(id){
  "use strict";
    var data = {};
    data.rel_id = <?php echo sa_html_entity_decode($estimate->id); ?>;
    data.rel_type = 'pur_order';
    data.addedfrom = <?php echo sa_html_entity_decode($estimate->addedfrom); ?>;
