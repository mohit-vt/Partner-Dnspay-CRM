...
// Ensure the module is registered as active in the `modules` table
// if (!$CI->db->field_exists('modules', db_prefix() . 'modules')) {
//     $CI->db->query("INSERT INTO `" . db_prefix() . "modules` (module_name, activated) VALUES ('sales_agent', 1)
