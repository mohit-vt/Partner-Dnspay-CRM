<script type="text/javascript">
    ...
    function init_workspace_table() {
      ...
      initDataTable('.table-workspaces', admin_url + 'social_analytic/workspaces_table', false, false, fnServerParams);
    }
    ...
    function set_default(workspace_id) {
        ...
        requestGetJSON('social_analytic/set_default_workspace/' + workspace_id).done(function(response) {
            if (response.success === true || response.success == 'true' || $.isNumeric(response.success)) {
              alert_float('success', response.message);
              init_workspace_table();
            }
