<div class="instagram-dashboard-stats">
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <?php
              $total = sum_from_table(db_prefix() . 'sa_analytics', array('field' => 'value', 'where' => array('type = "impression" AND '. $where)));
              ?>
        <p><?php echo number_format($total ?? 0); ?></p>
      </div>
      <div class="tooltip-container">
        <i class="fas fa-question-circle tooltip-icon"></i>
        <span class="tooltip-text"><?php echo _l('instagram_total_impressions_note')?></span>
      </div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="tooltip-container">
        <i class="fas fa-question-circle tooltip-icon"></i>
        <span class="tooltip-text"><?php echo _l('instagram_total_engagements_note')?></span>
      </div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-info">
        <h3><?php echo _l('sa_profile_actions'); ?></h3>
        <?php
              $total = sum_from_table(db_prefix() . 'sa_analytics', array('field' => 'value', 'where' => array('type = "profile_action" AND '. $where)));
              ?>
        <p><?php echo number_format($total ?? 0); ?></p>
      </div>
      <div class="tooltip-container">
        <i class="fas fa-question-circle tooltip-icon"></i>
        <span class="tooltip-text"><?php echo _l('instagram_total_profile_actions_note')?></span>
      </div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="tooltip-container">
        <i class="fas fa-question-circle tooltip-icon"></i>
        <span class="tooltip-text"><?php echo _l('instagram_total_followers_note')?></span>
      </div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="tooltip-container">
        <i class="fas fa-question-circle tooltip-icon"></i>
        <span class="tooltip-text"><?php echo _l('instagram_total_comments_note')?></span>
      </div>
    </div>
</div>
