        ...
        <div class="row _buttons">
          ...
          <div class="_hidden_inputs _filters _tasks_filters">
              ...
              echo form_hidden('date_filter');
                ...
                $facebook_accounts = sa_get_account_ids_by_base_workspace('facebook');
                foreach ($facebook_accounts as $account) {
                    echo form_hidden('account_id_' . $account['id'], $account['id']);
                }

                $instagram_accounts = sa_get_account_ids_by_base_workspace('instagram');
                foreach ($instagram_accounts as $account) {
                    echo form_hidden('account_id_' . $account['id'], $account['id']);
                }

                $tiktok_accounts = sa_get_account_ids_by_base_workspace('tiktok');
                foreach ($tiktok_accounts as $account) {
                    echo form_hidden('account_id_' . $account['id'], $account['id']);
                }

                $twitter_accounts = sa_get_account_ids_by_base_workspace('twitter');
                foreach ($twitter_accounts as $account) {
                    echo form_hidden('account_id_' . $account['id'], $account['id']);
                }

                $youtube_accounts = sa_get_account_ids_by_base_workspace('youtube');
...
<?php init_tail(); ?>
<?php require('modules/social_analytic/assets/js/analytics/manage_js.php'); ?>
</body>
</html>
