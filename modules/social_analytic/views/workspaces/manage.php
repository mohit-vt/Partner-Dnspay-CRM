 ...
 <div class="content">
    <div class="panel_s">
     <div class="panel-body">
      <div class="_buttons">
        <a href="#" onclick="add_workspace(); return false;" class="btn btn-primary mbot10"><?php echo _l('ma_add_new', _l('workspace')); ?></a>
...
<?php init_tail(); ?>
<?php require 'modules/social_analytic/assets/js/workspace/manage_js.php';?>
