         ...
         <div class="col-md-6">
            <div class="panel_s mtop15">
               <div class="panel-body">
                 ...
                 <?php echo form_open_multipart(admin_url('social_analytic/workspace'),array('id'=>'workspace-form'));?>
                 ...
                 <?php echo form_hidden('id', $workspace->id); ?>
                  ...
                  <div class="form-group">
                      <div class="row">
                          <div class="col-md-9">
                              <?php echo workspace_logo_html($workspace->id, ['img', 'img-responsive', 'staff-profile-image-thumb'], 'thumb'); ?>
                          </div>
                          <div class="col-md-3 text-right">
                              <a href="<?php echo admin_url('social_analytic/remove_workspace_logo/'.$workspace->id); ?>"><i
                  ...
                  <div role="tabpanel" class="tab-pane" id="staff_permissions">
                     <?php echo form_open(admin_url('social_analytic/workspace_display_chart'),array('id'=>'workspace-display-chart-form'));?>
                  <?php echo form_hidden('id', $workspace->id); ?>
                     <?php echo $this->load->view('display_charts/overview'); ?>
                     <?php echo $this->load->view('display_charts/facebook'); ?>
                     <?php echo $this->load->view('display_charts/instagram'); ?>
                     <?php echo $this->load->view('display_charts/tiktok'); ?>
                     <?php echo $this->load->view('display_charts/twitter'); ?>
                     <?php echo $this->load->view('display_charts/youtube'); ?>
                     <?php if(is_admin() || $workspace->super_admin == get_staff_user_id() || $workspace->addedfrom == get_staff_user_id()){ ?>
                        <hr>
                        <button type="submit" class="btn btn-primary btn-submit"><?php echo _l('submit'); ?></button>
                    <?php } ?>  
...
<div class="modal fade" id="add-member-modal">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open_multipart(admin_url('social_analytic/add_workspace_member'),array('id'=>'add-member-form'));?>
...
<div class="modal fade" id="add-contact-modal">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open_multipart(admin_url('social_analytic/add_workspace_member'),array('id'=>'add-contact-form'));?>
         <?php echo form_hidden('workspace_id', $workspace->id); ?>
...
<?php init_tail(); ?>
<?php require 'modules/social_analytic/assets/js/workspace/workspace_detail_js.php';?>
