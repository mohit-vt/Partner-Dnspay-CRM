         ...
         <div class="col-md-12">
            ...
            <div class="horizontal-tabs mb-5">
              ...
              foreach($tab as $gr){ ?> 
                ...
                <a href="<?php echo admin_url('social_analytic/social_accounts?type='.$gr); ?>" data-group="<?php echo html_entity_decode($gr); ?>">
...
<div class="modal fade" id="account-modal">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open_multipart(admin_url('social_analytic/social_account'),array('id'=>'account-form'));?>
...
<?php init_tail();?>
<?php require 'modules/social_analytic/assets/js/social_accounts/manage_js.php';?>
