        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <a href="<?php echo admin_url('social_analytic/get_tiktok_data/'.$account->id); ?>" class="btn btn-primary mbot15 mleft5 pull-right"><?php echo _l('sync_data'); ?></a>
          ...
          <table class="table table-workspaces">
            <thead>
              ...
              <th><?php echo _l('sa_video_views'); ?></th>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
              ...
              <?php $type = [
                ...
                ['id' => 'video_view', 'name' => _l('sa_video_view')], 
              ...
              <?php echo render_select('engagement', $gender, array('id', 'name'), 'engagement', '', array(), array(), '', '') ?>
              </div>
