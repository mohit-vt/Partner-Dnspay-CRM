        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <a href="<?php echo admin_url('social_analytic/get_instagram_data/'.$account->id); ?>" class="btn btn-primary mbot15 mleft5 pull-right"><?php echo _l('sync_data'); ?></a>
          ...
          <table class="table table-workspaces">
            <thead>
              ...
              <th><?php echo _l('sa_profile_actions'); ?></th>
              ...
              <th><?php echo _l('sa_published_stories'); ?></th>
              <th><?php echo _l('sa_stories_performance'); ?></th>
            </thead>
            <tbody>
            </tbody>
          </table>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
              ...
              <?php $type = [
                ...
                ['id' => 'profile_action', 'name' => _l('sa_profile_action')], 
                ['id' => 'follower', 'name' => _l('sa_follower')], 
                ['id' => 'comment', 'name' => _l('sa_comment')], 
                ['id' => 'post', 'name' => _l('sa_post')], 
                ['id' => 'active_user', 'name' => _l('sa_active_user')], 
                ['id' => 'published_stories', 'name' => _l('sa_published_stories')], 
                ['id' => 'stories_performance', 'name' => _l('sa_stories_performance')], 
              ]; ?>
              ...
              <div class="stories-performance-sub-type hide">
                <?php $stories_performance = [
                ['id' => 'story_replies', 'name' => _l('story_replies')], 
                ['id' => 'story_tap_backs', 'name' => _l('story_tap_backs')], 
                ['id' => 'story_taps_forward', 'name' => _l('story_taps_forward')], 
                ['id' => 'story_exits', 'name' => _l('story_exits')], 
                ['id' => 'story_reach', 'name' => _l('story_reach')], 
                ['id' => 'story_impressions', 'name' => _l('story_impressions')], 
              ]; ?>
              <?php echo render_select('stories_performance', $stories_performance, array('id', 'name'), 'sa_stories_performance', '', array(), array(), '', '') ?>
              </div>
