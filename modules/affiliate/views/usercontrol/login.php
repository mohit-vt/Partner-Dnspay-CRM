...
<div class="mtop40">
   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
      <?php echo form_open(site_url('affiliate/authentication_affiliate/login'),array('class'=>'login-form')); ?>
         ...
         <div class="panel-body">
           ...
           <!--  <?php if(get_option('use_recaptcha_customers_area') == 1
            ...
            <div class="form-group">
               ...
               <div class="col-md-6">
              <a href="<?php echo site_url('affiliate/authentication_affiliate/register'); ?>" class="btn btn-success btn-block"><?php echo _l('clients_register_string'); ?></a>
