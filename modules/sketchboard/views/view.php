<?php init_head(); ?>
<div id="wrapper">
    <div class="content tw-py-10" id="full_screen">
        <div class="row _buttons tw-mb-2">
            ...
            <?php } ?>
             <a href="<?=admin_url('sketchboard')?>" class="btn btn-info pull-right mright5"><?= _l('back')?></a>
...
<?php echo render_input('sketch_data', 'sketch_data', '', 'hidden'); ?> 
<?php echo form_close(); ?>
