...
<div class="col-md-12">
     <h4 class="bold well email-template-heading">
          <?php echo _l('zmm_module_name'); ?>
          <?php if ($hasPermissionEdit) { ?>
               <a href="<?php echo admin_url('emails/disable_by_type/zoom_meeting_manager'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
               <a href="<?php echo admin_url('emails/enable_by_type/zoom_meeting_manager'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
          <?php } ?>
     ...
     <div class="table-responsive">
          <table class="table table-bordered">
               ...
               <tbody>
                    <?php foreach ($zoom_meeting_manager_templates as $template) { ?>
                         <tr>
