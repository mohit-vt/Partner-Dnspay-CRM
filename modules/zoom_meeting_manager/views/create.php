                    ...
                    <div class="panel_s">
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php echo render_select('staff[]', $staff_members, ['staffid', ['firstname', 'lastname']], 'staff', [], ['multiple' => true], [], '', '', false); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 no-padding">
                                ...
                                <button type="submit" id="btnScheduleMeeting" class="btn btn-primary pull-right"><?= _l('zmm_shedule_label'); ?></button>
                                <?php
                                /**
                                 * User Types
                                 * 1 - Free
