    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        elseif($aColumns[$i] == 'created_at'){
            ...
            if(!($aRow['capture_image'] == '' || $aRow['capture_image'] == null)){
              	// This below line commented for showing the uploaded invoice templates on 01.02.2025
                //$_data = '<div class="image-contain list-template-image"><img class="base64-image pointer" src="data:image/png;base64,'.$aRow['capture_image'].'"></div>';
                              $_data = '<div class="image-contain list-template-image"><img class="base64-image pointer" src="'.base_url('modules/invoices_builder/assets/images/'. $aRow['capture_image']).'"></div>';
            }
            else{
