...
$is_activated = true; // Assume module is always activated
$activated_date = new DateTime(); // Current date as activated date

$license_name = get_option(PROJECT_MANAGEMENT_ENHANCEMENTS_MODULE_NAME . '_customer_name') ?? 'Bypassed User';
$license_email = get_option(PROJECT_MANAGEMENT_ENHANCEMENTS_MODULE_NAME . '_customer_email') ?? 'bypass@example.com';
$license_key = get_option(PROJECT_MANAGEMENT_ENHANCEMENTS_MODULE_NAME . '_license_key') ?? 'bypassed-license-key';
                    ...
                    <div class="panel_s">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customer_name" class="control-label"><?php echo _l(
												'zegaware_customer_name'
											) ?>*</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customer_email" class="control-label"><?php echo _l(
												'zegaware_customer_email'
											) ?>*</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customer_envato_username" class="control-label"><?php echo _l(
												'zegaware_customer_envato_username'
											) ?></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="license_key" class="control-label"><?php echo _l(
												'zegaware_license_key'
											) ?>*</label>
