...
<script>
    ...
    function edit_task_type(invoker, project_id, task_type_id) {
        ...
        $('#task_type input[name="name"]').val($(invoker).data("name"));
        $('#task_type textarea[name="label_color"]').val($(invoker).data("label-color"));
        $('#task_type input[name="sort_order"]').val(parseInt($(invoker).data("sort-order")));
