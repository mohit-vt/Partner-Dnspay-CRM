...
$certFilePath = module_dir_path(ACCOUNTING_MODULE_NAME).'/assets/plugins/OAuth_2//Certificate/cacert.pem';
//$certFilePathOpenID = './Certificate/sandbox_all_platform_intuit_com.pem';
$certFilePathOpenID = module_dir_path(ACCOUNTING_MODULE_NAME).'/assets/plugins/OAuth_2//Certificate/cacert.pem';
