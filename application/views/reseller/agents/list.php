        ...
        <div class="row">
            ...
            <hr>
                <div class="panel_s">
                    ...
                    <a href="<?php echo site_url('reseller/agents/create'); ?>" class="btn btn-primary">Add New</a>
                            ...
                            <?php if (count($pipeline_reports) === 0) { ?>
                                ...
                                <?php foreach ($pipeline_reports as $report) { ?>
                                    ...
                                    <td><input type="checkbox" class="client_checkbox" value="<?= $report['id']; ?>"></td>
                                        ...
                                        <td>
                                            <a style="background:#90D5FF !important" href="<?php echo site_url('reseller/agents/view/' . $report['id']); ?>" class="btn btn-sm btn-info">View</a>
