            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <hr>
                    <?php echo form_open(base_url('reseller/agents/submit'), ['class' => 'agents-form']); ?>
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" class="form-control" maxlength="10" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="website">Office Number *</label>
									 <input type="tel" id="office_number" name="office_number" class="form-control" maxlength="10" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
