            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open(base_url('reseller/agents/update/'.$agents['id']), ['class' => 'agents-form']); ?>
                        ...
                        <div class="row">
                            ...
                            <!-- Primary Interest - Checkbox Version -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Your primary interest is *</label>
                    <select id="primary_interest[]" name="primary_interest" class="form-control">
                                 <option value="">Select</option>
                                     ...
                                     <option value="Bonus Program" <?= isset($agents['primary_interest']) && $agents['primary_interest'] == 'Bonus Program' ? 'selected' : '' ?>>Bonus Program</option>
                                      <option value="Residual Loan" <?= isset($agents['primary_interest']) && $agents['primary_interest'] == 'Residual Loan' ? 'selected' : '' ?>>Residual Loan</option>
               ...
               class="form-control" placeholder="Enter your interest">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" value="<?= html_escape($agents['phone'] ?? '') ?>" class="form-control" maxlength="12" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="website">Office Number *</label>
									 <input type="tel" id="office_number" name="office_number" value="<?= html_escape($agents['office_number'] ?? '') ?>" class="form-control" maxlength="12" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
