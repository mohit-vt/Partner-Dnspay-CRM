...
<body class="tw-bg-neutral-100 authentication forgot-password">
    ...
    <div class="tw-max-w-md tw-mx-auto tw-pt-24 authentication-form-wrappe tw-relative tw-z-20">
        <div class="company-logo text-center">
               <img src="https://dashboard.edata24.com/uploads/company/company-default-logo.png" class="img-responsive" alt="Merchant Services, Global Payments and Platforms Provider Powered by Business Media Group" >
        </div>
