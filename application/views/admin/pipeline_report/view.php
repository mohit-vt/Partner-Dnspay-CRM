        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <?php echo form_open(admin_url('pipeline_report/update/'.$pipeline_report['id']), ['class' => 'pipeline_report-form', 'enctype' => 'multipart/form-data']); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" id="application_date" name="application_date" value="<?= $pipeline_report['application_date'] ?? '' ?>" class="form-control" >
            ...
            <input type="hidden" name="pre_application_id" value="<?= $pipeline_report['pre_application_id'] ?? '' ?>" >
                ...
                <?php  
                    ...
                    $allowed_roles = ['partner admin', 'Relationship Management Team'];

                    if ( is_admin() || in_array(strtolower($rolevalue->name), $allowed_roles)) {  
                ?>
                <div class="col-md-6">
                    <div class="form-group">
              ...
              <?php if (!empty($staff_agents)): ?>
                <?php foreach ($staff_agents as $agent): ?>
                    <option value="<?= $agent->staffid ?>"
                        <?= (isset($pipeline_report['assigned_to_agent']) && $agent->staffid == $pipeline_report['assigned_to_agent']) ? 'selected' : '' ?>>
            ...
            <?php } ?>
                              ...
                              <div class="col-md-6">
                    <div class="form-group">
                        <label for="assigned_to_mst">Assigned to Merchant:</label>
                        <select id="assigned_to_mst" name="assigned_to_merchant" class="form-control">
                           <option value="" selected>Select Merchant Group</option>
                        <?php 
                        $selected_status = isset($pipeline_report) ? $pipeline_report['assigned_to_merchant'] : 'Please Select'; 
                        ?>
                        <option value="Group RM" <?= ($selected_status == 'Group RM') ? 'selected' : ''; ?>>Group RM</option>
                        <option value="Sales Team USA" <?= ($selected_status == 'Sales Team USA') ? 'selected' : ''; ?>>Sales Team USA</option>
                        <option value="Sales Team EU" <?= ($selected_status == 'Sales Team EU') ? 'selected' : ''; ?>>Sales Team EU</option>
                        <option value="Sales Team LATAM" <?= ($selected_status == 'Sales Team LATAM') ? 'selected' : ''; ?>>Sales Team LATAM</option>
                        <option value="Sales Team Asia" <?= ($selected_status == 'Sales Team Asia') ? 'selected' : ''; ?>>Sales Team Asia</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="company_name" name="company_name" value="<?= $pipeline_report['company_name'] ?? '' ?>" class="form-control" >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="business_address" name="business_address" value="<?= $pipeline_report['business_address'] ?? '' ?>" class="form-control">
                    </div>
                </div>
            ...
            <input type="tel" id="business_phone" name="business_phone"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="url" id="website_url" name="website_url" value="<?= !empty($pipeline_report['website_url']) ? $pipeline_report['website_url'] : 'https://'; ?>"  class="form-control">
                    </div>
                </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <small id="otherMessage"
               class="text-danger"
               style="display: <?= (isset($pipeline_report['mcc_code']) && strtoupper($pipeline_report['mcc_code']) === 'OTHER') ? 'block' : 'none' ?>; margin-top:5px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="tel" id="contact_phone" name="contact_phone" class="form-control" value="<?= $pipeline_report['contact_phone'] ?? '' ?>" placeholder="Enter phone number"
                   maxlength="12"
                   oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                </div>
            </div>
