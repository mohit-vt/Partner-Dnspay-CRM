            ...
            <input type="hidden" name="pre_application_id" id="pre_application_id">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="assigned_to_mst" id="assigned_to_mst" class="form-control" title="Source Of The lead">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="assigned_to_merchant">Assigned to Merchant:</label>
                        <select id="assigned_to_merchant" name="assigned_to_merchant" class="form-control" required>
                            <option value="" selected>Select Merchant Group</option>
                            <option value="Group RM">Group RM</option>
                            <option value="Sales Team USA">Sales Team USA</option>
                            <option value="Sales Team EU">Sales Team EU</option>
                            <option value="Sales Team LATAM">Sales Team LATAM</option>
                            <option value="Sales Team Asia">Sales Team Asia</option>
                        </select>
                    </div>
                </div>
        ...
        <select id="country_code" name="country_code" class="form-control select2">
                ...
                <?php foreach ($countries as $country): ?>
                    <?php 
                        ...
                        // Some have multiple like "1+809, 8" → clean formatting
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="tel" id="business_phone" name="business_phone"
               value="<?= $pre_application['business_telephone_number'] ?? '' ?>"
               class="form-control"
               maxlength="14"
    ...
    <div class="form-group">
        ...
        <select id="incorporation_country" name="incorporation_country" class="form-control">
            ...
            usort($countries, function($a, $b) {
                return ($a['short_name'] === 'United States') ? -1 : 1;
            });
          ...
          <div class="row representative" data-index="1">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="tel" id="contact_phone" name="contact_phone" value="<?= $pre_application['cell_number'] ?? '' ?>"  class="form-control"  maxlength="12" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                </div>
            </div>
            <!-- Email Address -->
            <div class="col-md-6">
            ...
            <div class="col-md-6"> 
                <div class="form-group">
                    ...
                    <input type="text" id="id_number" 
                           name="id_number" 
                           value="<?= $pre_application['ssn_passport'] ?? '' ?>" 
                           class="form-control"
                           required
                           oninput="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'');">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="merchant_status" name="merchant_status"  class="form-control" >
    ...
    <?php  $rolevalue = $this->roles_model->get($current_user->role); if (($rolevalue->name == "Employee" || $rolevalue->name == "Management")) {  ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                                <div class="form-group">
                                    <label for="upload_file">Other Documents</label>
...
<?php  $rolevalue = $this->roles_model->get($current_user->role); if (($rolevalue->name == "Employee" || $rolevalue->name == "Management")) {  ?>
          ...
          $staff_data = $this->staff_model->get($staff_id); // returns an object
...
function checkOwnershipPercentage(input) {
    ...
    if (percentage > 25) {
        ...
        if (!lastRep) return; // safety check
