    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (is_admin()): ?>    
                <!--<a href="<?php echo admin_url('utilities/logout_all_users'); ?>" 
                class="btn btn-danger float-right">-->
                  <a href="<?php echo admin_url('utilities/logout_all_users'); ?>" 
   class="btn btn-danger float-right" 
   onclick="return confirm('Are you sure you want to activate the Kill Switch? This will logout and disable all users except Super Admin.');">
   <i class="fa fa-power-off"></i> Logout All Users
</a>
