            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                   ...
                   <dt class="lead-field-heading tw-font-normal tw-text-neutral-500">
                    ...
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?= date('F d, Y h:i A', strtotime($lead->dateadded)); ?>
                    </dd>               
                    <dt class="lead-field-heading tw-font-normal tw-text-neutral-500">
                        <?= _l('Page URL'); ?>
                    </dt>
...
?>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var iframe = document.getElementById("leadFormIframe"); // Get iframe
        var referrerUrl = encodeURIComponent(window.location.href); // Get current page URL

        // Set the iframe source dynamically
        iframe.src = "https://royalsecurecrm.com/forms/wtl/381224ee45e14d6a7044357998c75584?referrer=" + referrerUrl;
    });
</script>
