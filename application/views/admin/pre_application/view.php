        ...
        <div class="row">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        $form_action = isset($copy_mode) && $copy_mode
                            ? admin_url('pre_application/submit')
                            : (isset($pre_application['id']) ? admin_url('pre_application/update/' . $pre_application['id']) : admin_url('pre_application/submit'));

                        echo form_open($form_action, ['class' => 'pre_application-form', 'enctype' => 'multipart/form-data']);
                        ?>
            ...
            <?php foreach (get_all_countries() as $country) { ?>
                <?php
                    ...
                    if (!empty($pre_application['country']) && $pre_application['country'] == $country['country_id']) {
                        $selected = true;
                    }

                    // If no reseller country, default to United States
                    if (empty($pre_application['country']) && $country['short_name'] === "United States") {
                        $selected = true;
                    }
                ?>
            ...
            <?php } ?>
                            ...
                            <div class="col-md-6">
  							...
  							<input type="tel" id="cell_number" name="cell_number" value="<?= $pre_application['cell_number'] ?>" class="form-control" pattern="\d*" maxlength="14" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,14);" required>
                                </div>
                        </div> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ssn_passport" name="ssn_passport" value="<?= $pre_application['ssn_passport'] ?>" class="form-control" maxlength="30" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,30);" required>
                                </div>
                        </div>                     
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="business_telephone_number" value="<?= $pre_application['business_telephone_number'] ?>"  name="business_telephone_number" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'');"  maxlength="12" class="form-control">
                                </div>
                        </div>
                        <div class="col-md-6">
                                <div class="form-group">
            ...
            <?php foreach (get_all_countries() as $country) { ?>
                <?php
                    ...
                    if (!empty($pre_application['business_country']) && $pre_application['business_country'] == $country['country_id']) {
                        $selected = true;
                    }

                  
                    if (empty($pre_application['business_country']) && $country['short_name'] === "United States") {
                        $selected = true;
                    }
                ?>
                <option value="<?= e($country['country_id']); ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bank_phone_number" name="bank_phone_number"  value="<?= $pre_application['bank_phone_number'] ?>"  class="form-control">
                                </div>
                                </div>
