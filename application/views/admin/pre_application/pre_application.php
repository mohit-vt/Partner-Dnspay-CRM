            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open(admin_url('pre_application/submit'), ['class' => 'pre_application-form', 'enctype' => 'multipart/form-data']); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cell_number">Cell Telephone Number:</label>
                                         <input type="tel" id="cell_number" name="cell_number" class="form-control" pattern="\d*"
               maxlength="14" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,14);" required>
                                </div>
                        </div> 
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ssn_passport" name="ssn_passport" class="form-control" maxlength="30" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,30);" required>
                                </div>
                        </div>   
                    ...
                    <select name="business_type" id="business_type" class="form-control" required title="Business Type">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="business_telephone_number"  name="business_telephone_number" pattern="\d*"
               oninput="this.value=this.value.replace(/[^0-9]/g,'');"  maxlength="10" class="form-control">
                                </div>
                        </div>
                        <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bank_phone_number" name="bank_phone_number" class="form-control" pattern="\d*"
