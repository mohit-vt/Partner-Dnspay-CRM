...
define('APP_BASE_URL', 'https://partner.dnspay.com/');
...
*/
define('APP_ENC_KEY', 'd16e2d5277d789cdd2fe61e7760003d9');
 ...
 */
define('APP_DB_USERNAME', 'dnspay_parnter');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'dEjFdh83WmZQ');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'dnspay_parnter');
