...
$is_local = stripos($host, 'localhost') !== false;

// If localhost → no domain needed
// If live → use .edata24.com for all sessions
$cookie_domain = $is_local ? '' : '.partner.dnspay.com';

$config['cookie_domain']        = $cookie_domain;
$config['csrf_cookie_domain']   = $cookie_domain;

$config['cookie_path'] = '/';
$config['csrf_cookie_path'] = '/';


// Default SameSite for Perfex
$config['cookie_samesite']      = 'Lax';
$config['sess_cookie_samesite'] = 'Lax';
...
//$config['cookie_domain']   = '.edata24.com';

$config['csrf_cookie_samesite'] = 'Lax';
...
//$cookie_domain = '.dashboard.edata24.com';   // <-- MUST be here (line by itself)

// ------------------------------------------------------------
// Affiliate Cookie + Session Override
// ------------------------------------------------------------

// -----------------------------
// AFFILIATE SESSION OVERRIDE
// -----------------------------
// Run this when URL includes /affiliate/ so affiliate sessions are isolated
...
/* -----------------------------------------------------------
 * FINAL AFFILIATE SESSION OVERRIDE (MUST BE AT BOTTOM)
 * ----------------------------------------------------------- */
...
$config['csrf_exclude_uris'] = array_merge($config['csrf_exclude_uris'],array('facebookleadsintegration/webhook'));
$config['csrf_exclude_uris'] = array_merge($config['csrf_exclude_uris'],array('facebookleadsintegration/get_lead_data'));

// Disable CSRF only for affiliate system
