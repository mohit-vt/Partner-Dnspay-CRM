...
$db['default'] = array_merge([
    'dsn'          => '', // Not Supported
    'hostname'     => 'localhost',
    'username'     => 'dnspay_partner',
    'password'     => 'dEjFdh83WmZQ',
    'database'     => 'dnspay_partner',
...
$db['agent_crm'] = array_merge([
    'dsn'          => '', // Not Supported
    'hostname'     => APP_DB_HOSTNAME,
    'username'     => 'dnspay_agepart',
    'password'     => '9a8Uayg3aJyF',
    'database'     => 'dnspay_agepart',
    'dbdriver'     => defined('APP_DB_DRIVER') ? APP_DB_DRIVER : 'mysqli',
    'dbprefix'     => '',
    'pconnect'     => false,
    'db_debug'     => (ENVIRONMENT !== 'production'),
