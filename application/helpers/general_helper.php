...
function show_access_denied()
{
    ...
    echo $CI->load->view('errors/html/access_denied', [], true);
    exit;
}
...
//This helper gives the User Agent details in limited to fetch only the browser details,
...
function get_browser_details($user_agent) {
