...
class Leads_model extends App_Model
{
    ...
    {
        $this->db->select('*,' . db_prefix() . 'leads.name, ' . db_prefix() . 'leads.id,' . db_prefix() . 'leads_status.name as status_name,' . db_prefix() . 'leads.dateadded, ' . db_prefix() . 'leads.remote_ip, ' . db_prefix() . 'leads.user_agent, ' . db_prefix() . 'leads.page_url,' . db_prefix() . 'leads_sources.name as source_name');
